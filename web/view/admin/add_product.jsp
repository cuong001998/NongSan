...
<html>
    <head>
        ...
        <title>JSP Page add product</title>
    </head>
    <body>
       <c:url var= "url" value ="/admin/product/add"></c:url>
                ...
                <section  class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="file"  class="form-control" name="imageFile"  accept="image/*" value="${product.imageName}">
                                <i> ${message[4]}</i>
                            </div>
                        </div>  
                         <!-- form-group button -->       
